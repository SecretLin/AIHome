...
public class WC extends Fragment implements View.OnClickListener, TextView.OnEditorActionListener, SeekBar.OnSeekBarChangeListener {
...
// 数据点"开灯"对应的标识名
    ...
    // 数据点"厕所抽风机"对应的标识名
    protected static final String KEY_WC_FAN_ONOFF = "WC_fan_OnOff";
...
// 数据点"开灯"对应的存储数据
    ...
    // 数据点"厕所抽风机"对应的存储数据
    protected static boolean data_WC_fan_OnOff;
    ...
    private Switch sw_bool_WC_fan_OnOff;
...
//                progressDialog.cancel();
    ...
    private void initView(View view) {
        ...
        sw_bool_WC_fan_OnOff =(Switch) view.findViewById(R.id.sw_bool_wc_fan_OnOff);
        ...
        sw_bool_WC_fan_OnOff.setOnClickListener(this);
...
//没有设备的时候
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.sw_bool_Curtain_OnOff:
                ...
                break;
            case R.id.sw_bool_wc_fan_OnOff:
                sendCommand(KEY_WC_FAN_ONOFF, sw_bool_WC_fan_OnOff.isChecked());
                break;
    ...
    protected void updateUI() {
        ...
        sw_bool_WC_fan_OnOff.setChecked(data_WC_fan_OnOff);
    ...
    protected void getDataFromReceiveDataMap(ConcurrentHashMap<String, Object> dataMap) {
        ...
        if (dataMap.get("data") != null) {
            ...
            for (String dataKey : map.keySet()) {
                ...
                if (dataKey.equals(KEY_WC_FAN_ONOFF)) {
                    data_WC_fan_OnOff = (Boolean) map.get(dataKey);
                }
            }
        }
    }
